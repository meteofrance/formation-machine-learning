...
def plot_example_decision_tree():
    ...
    ax.set_title('Exemple d\'arbre de décision: Classification d\'un animal', size=24)
    ...
    text(ax, 0.5, 0.9, "Taille de l'animal?", 20)
    text(ax, 0.3, 0.6, "L'animal a-t-il des cornes?", 18)
    text(ax, 0.7, 0.6, "L'animal a-t-il\n deux pattes?", 18)
    text(ax, 0.12, 0.3, "Les cornes\n supérieures à 10cm?", 14)
    text(ax, 0.38, 0.3, "L'animal porte-t-il\nun collier?", 14)
    text(ax, 0.62, 0.3, "L'animal a-t-il\n des ailes?", 14)
    text(ax, 0.88, 0.3, "L'animal a-t-il\n une queue?", 14)

    text(ax, 0.4, 0.75, "> 1m", 12, alpha=0.4)
    text(ax, 0.6, 0.75, "< 1m", 12, alpha=0.4)

    text(ax, 0.21, 0.45, "oui", 12, alpha=0.4)
    text(ax, 0.34, 0.45, "non", 12, alpha=0.4)

    text(ax, 0.66, 0.45, "oui", 12, alpha=0.4)
    text(ax, 0.79, 0.45, "non", 12, alpha=0.4)
